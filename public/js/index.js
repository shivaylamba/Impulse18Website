...
var MAX_TOP =  Math.floor((70/100)*canvas.height); //
var c = canvas.getContext('2d');
//var middlepositionX = Math.random()
...
function Fireworks(starty,endy,radius){
...
var cannonballs = [];
        ...
        window.addEventListener("resize",function(){
            ...
            MAX_TOP = Math.floor((70/100)*canvas.height);
...
function animate()
{
    ...
    //     }
          ...
          timer++;
          if(timer%40==0){
          cannonballs.push(new Fireworks(canvas.height,Math.random()*MAX_TOP,4));}
